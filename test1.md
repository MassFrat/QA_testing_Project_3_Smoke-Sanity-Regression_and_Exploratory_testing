...
| Product Pages           | Image gallery, option selectors, wishlist                             |
...
|-----------------------|------------------------------------------------------------------------|
| **Browser**           | Firefox / Chrome (latest)                                              |
| **Developer Tools**   | F12 — Console, Network, Responsive Design Mode                         |
| **Operating System**  | Windows                                                                |
| **Screen Size**       | 1920 × 1080 (desktop)                                                  |
| **Mobile Testing**    | Responsive Design Mode — iPhone 14 Pro                          |
